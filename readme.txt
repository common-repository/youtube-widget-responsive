...
Tags: youtube, responsive, widget, autoplay, youtube embed, youtube plugin, embed youtube, embedding youtube, seo youtube, no-cookie, youtube plugin, youtube WPBakery Page Builder, sidebar, simple youtube, annotations, wordpress youtube widget, wordpress youtube embed, video plugin, video widget, shortcode youtube, shortcode, youtube schema.org, youtube schemaorg, youtube schema.org/VideoObject, youtube schema.org VideoObject
Requires at least: 3.0.1
Tested up to: 6.5.5
Stable tag: 1.6.2
License: GPLv2 or later

Widgets + ShortCode responsive to embed youtube in your sidebar or in your content [youtube video=...] or in WPBakery Page Builder, with SEO http://schema.org/VideoObject fields.
Share your channel with YouTube button subscribe.

== Description ==

Widgets + ShortCode responsive to embed youtube in your sidebar or in your content [youtube video=...] or in WPBakery Page Builder, with all available options and http://schema.org/VideoObject fields.
...
Upload the Youtube Widget Responsive plugin to your blog, Activate it, Add in your sidebar from Widgets OR put in the content [youtube video=link_youtube] or in WPBakery Page Builder.
...
You can put the link of playList like

https://www.youtube.com/watch?v=KQ6zr6kCPj8&list=PLQJ9EnwZbMoLAW3MJ-B91YwcZnM9GvTPv

or 

list=PLQJ9EnwZbMoLAW3MJ-B91YwcZnM9GvTPv

You can put the link of your user video uploaded like
...
For the translation https://translate.wordpress.org/projects/wp-plugins/youtube-widget-responsive/
...
= 1.6.2 =
* fixed vulnerability
* Vulnerability Title: Widget Responsive for Youtube <= 1.6.1 - Authenticated (Contributor+) Stored Cross-Site Scripting via Shortcode​
...
= 1.4.5 =
* Change display name for trademark

= 1.4.4 =
* fix compatibility with WPFront User Role Editor

= 1.4.3 =
* fix loading on WPBakery Page Builder

= 1.4.2 =
* fix possibility to save widget if change only image preview

= 1.4.1 =
* fix channel ID for button subscribe

= 1.4 =
* WPBakery Page Builder add-on
* restyling widget form
* added youtube button subscribe
* added possibility to print description below the video using schema.org section

= 1.3.3 =
* added fitvidsignore class (if your theme apply fitvids, need to update theme or fitvids js)
* added play uploaded videos from user "list=LMFAOVEVO&listType=user_uploads"
* replace LMFAOVEVO with user channel

= 1.3.2 =
* fixed problem with FitVids.js compatibility

= 1.3.1 =
* fixed problem with data attribute on <object>
    ...
    <li><strong>video</strong> (required)
        <ul>
            <li>The link at the video 
                ...
                or only the id of video like
                _9tBFVKhn5o
                or link to uploads video of user
                "list=LMFAOVEVO&listType=user_uploads"
            </li>
        </ul>
    </li>
